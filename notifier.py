...
t.title('Notifier')
t.geometry("500x300")
img = Image.open("notify-label1.png")
...
def play_notification_sound(sound_path=None):
    if sound_path:
        ...
        winsound.PlaySound("A Alert for you.wav", winsound.SND_FILENAME)
    else:
        # Play default system notification sound
        winsound.MessageBeep(winsound.MB_ICONASTERISK)

if __name__ == "__main__":
    # To play custom sound, replace None with a WAV file path
    play_notification_sound("C:\Users\Jakkula Shivani\OneDrive\Documents\Interview\GitHub\Desktop-Notification-\A Alert for you.wav")
